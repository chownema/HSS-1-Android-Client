...
public class Crypto {
    ...
    public static String doubleEncryptData(byte[] data, Key senderKey, Key recipientKey) {
        ...
        for(int i = 0; i < chunks.size(); i++) {
            try {
                ...
                rsaCipher.init(Cipher.ENCRYPT_MODE, senderKey);
    ...
    public static byte[] doubleDecryptData(String data, Key senderKey, Key recipientKey) {
        ...
        int dataLengthRemaining = actualDataLength;
        ...
        for(int i = 0; i < encryptedChunks.size(); i++) {
            try {
                ...
                int dataLength = (dataLengthRemaining >= 100) ? 100 : dataLengthRemaining;
                dataLengthRemaining -= dataLength; // Add to server decrypt
